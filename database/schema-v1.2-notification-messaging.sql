...
CREATE TABLE IF NOT EXISTS notifications (
    ...
    subtype TEXT CHECK(subtype IN (
        ...
        'post_comment', 'comment_reply', '@mention'
    )),
    title TEXT NOT NULL,
    content TEXT,
    related_data TEXT,
...
('1.2.0', 'Notification and messaging system: notifications, notification_settings, messages, message_settings, push_subscriptions, email_digest_queue');

-- =============================================
-- v1.2 通知与私信管理数据库初始化完成
-- 
-- 系统初始化完成！
-- v1.1 + v1.2 共同构成完整的数据库结构
-- =============================================
