  ...
  return (
    <div className="flex items-center justify-center min-h-screen bg-gradient-to-b from-white to-gray-100 dark:from-slate-900 dark:to-slate-800 py-16 px-4">
      <div className="text-center max-w-md mx-auto">
        ...
        {/* 标题 */}
        <h1 className="text-3xl font-bold text-foreground mb-2 animate-fade-in animation-delay-100">
          页面未找到
        </h1>
        ...
        <Link
          to="/"
          className="inline-block bg-primary text-white px-6 py-3 rounded-lg hover:bg-primary/90 transition-colors transform hover:scale-105 duration-300 animate-fade-in animation-delay-300"
        >
          返回首页
        </Link>
