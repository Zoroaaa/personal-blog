...
export function LoginPage() {
  ...
  const isRegistrationEnabled = config?.feature_registration !== false;
  const isOAuthGitHubEnabled = config?.feature_oauth_github !== false;
          ...
          {isOAuthGitHubEnabled && (
            <>
              ...
              <button
                ...
                className="w-full flex items-center justify-center space-x-2 bg-muted text-foreground py-3 rounded-lg hover:bg-accent disabled:opacity-50 disabled:cursor-not-allowed font-medium transition-colors border border-border"
              >
