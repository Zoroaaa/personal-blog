  ...
  return (
    <div className={`border border-border rounded-lg overflow-hidden ${className}`}>
      ...
      <button
        ...
        className="w-full flex items-center justify-between p-3 bg-background dark:bg-card hover:bg-accent transition-colors"
      >
        <div className="flex items-center gap-3">
          ...
          <div className="text-left">
            <h4 className="font-medium text-foreground">SEO 优化助手</h4>
            ...
            <>
              ...
              <div className="space-y-2 mb-4">
                {analysis.checks.map((check, index) => (
                  <div
                    key={index}
                    className="flex items-start gap-2 p-2 rounded bg-background dark:bg-card"
                  >
            ...
            <>
              ...
              {showOptimized && (
                <div className="mt-4 border-t border-border pt-4">
                  ...
                  <div className="bg-background dark:bg-card rounded-lg p-3 max-h-60 overflow-y-auto">
                  ...
                  <div className="flex gap-2 mt-3">
                    ...
                    <button
                      ...
                      className="px-3 py-2 bg-muted dark:bg-muted text-foreground text-sm rounded-lg hover:bg-accent transition-colors"
                    >
                      取消
                    </button>
                  </div>
