            ...
            {user && (
              ...
              >
                ...
                {messageUnreadCount > 0 && (
                  <span className="absolute -top-1 -right-1 bg-primary/80 text-white text-xs rounded-full min-w-[18px] h-[18px] flex items-center justify-center px-1 font-medium">
